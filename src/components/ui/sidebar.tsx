  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "relative w-(--sidebar-width) bg-transparent transition-[width] duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)]",
      ...
      >
        <div
          ...
          className="flex size-full flex-col bg-sidebar/90 backdrop-blur-xl supports-backdrop-filter:bg-sidebar/80 group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:shadow-lg group-data-[variant=floating]:ring-1 group-data-[variant=floating]:ring-sidebar-border"
        >
          {children}
        </div>
      </div>
